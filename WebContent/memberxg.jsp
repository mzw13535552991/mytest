...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact-form">
					...
					<input type="hidden" name="id" value="${member.id}">
					    ...
					    <input name='filename' type='text' class="layui-input" value="${member.filename}" lay-verify="required"  style="width: 300px;" id='url' required size='50' value='' />&nbsp;<input type='button' value='上传'  class="layui-input" onClick="up('url')" style="width: 60px;height: 37px;"/>
