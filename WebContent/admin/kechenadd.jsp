		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/kechenAdd.do" onsubmit="return supplieradd()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					<input name='vfilename' type='text' class="layui-input" required  style="width: 300px;" id='vfilename'  size='50'  />&nbsp;<input type='button' value='上传'  class="layui-input" onClick="up('vfilename')" style="width: 60px;height: 37px;"/>
					</div>
				</div>
