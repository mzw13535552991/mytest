...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/activityAdd.do" onsubmit="return supplieradd()">
				...
				<div class="layui-form-item">
					...
					<select name="flag" >
					  <option value="恋爱知识">恋爱知识</option>
					  <option value="恋爱故事">恋爱故事</option>
					</select>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<textarea id="editor_id" name="content" style="width: 600;height: 280px;" placeholder="内容"  class="layui-textarea"  ></textarea>
					</div>
				</div>
