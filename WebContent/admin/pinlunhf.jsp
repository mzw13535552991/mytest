...
<script charset="utf-8" src="/curriculumssm/kindeditor/kindeditor-all.js"></script>
<script charset="utf-8" src="/curriculumssm/kindeditor/lang/zh-CN.js"></script>
<script>
...
uploadJson : '/curriculumssm/kindeditor/jsp/upload_json.jsp',
fileManagerJson : '/curriculumssm/kindeditor/jsp/file_manager_json.jsp',
...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/pinlunEdit.do" onsubmit="return supplieradd()">
				
				<input type="hidden" name="id" value="${pinlun.id}"/>
				
				
				<div class="layui-form-item">
					<label class="layui-form-label">回复内容</label>
					<div class="layui-input-block">  
					  	<textarea id="editor_id" name="hfcontent" style="width: 600;height: 280px;" placeholder="回复内容"  class="layui-textarea"  ></textarea>
					</div>
				</div>
...
<script type="text/javascript">
	...
	function up(tt)
	{
			    layer.open({
			      ...
			      area: ['450px', '200px'],
			      content: '/curriculumssm/upload.jsp?Result='+tt
			    });
	}	
