		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/movieAdd.do" onsubmit="return supplieradd()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input name='videoname' type='text' class="layui-input" lay-verify="required"  style="width: 300px;" id='zy' required size='50' value='' />&nbsp;<input type='button' value='上传'  class="layui-input" onClick="up('zy')" style="width: 60px;height: 37px;"/>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					    <textarea name="content" style="width: 600px;height: 100px;"   class="layui-textarea" oninvalid="setCustomValidity('影视介绍不能为空')" oninput="setCustomValidity('');" ></textarea>
					</div>
				</div>
